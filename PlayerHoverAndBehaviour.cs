...
public class PlayerHoverAndBehaviour : MonoBehaviour
{
	Rigidbody m_body;
	...
	IEnumerator OnTriggerEnter (Collider other)
	{
		...
		if (other.gameObject.tag == "Missile") {
			...
			//PlayerShards.Play ();
			//ExplodeFlame.Play ();
			AudioSource PlayerDestroyed = GetComponent<AudioSource> ();
